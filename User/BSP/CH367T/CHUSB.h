...
//引脚定义
/*******************************************************/
#define CH376_SPI                           SPI1

#define CH376_INT_PIN						GPIO_PIN_4
#define CH376_INT_PORT          			GPIOC
#define CH376_INT_CLK               		__GPIOC_CLK_ENABLE()


#define CH376_RST_PIN						GPIO_PIN_5
#define CH376_RST_PORT          			GPIOC
#define CH376_RST_CLK               		__GPIOC_CLK_ENABLE()
...
#define CH376_SCS_CLK               		__GPIOA_CLK_ENABLE()


#define SPI_CH376_SCS_LOW()      		    {HAL_GPIO_WritePin(CH376_SCS_PORT,CH376_SCS_PIN,0);}
#define SPI_CH376_SCS_HIGH()     			{HAL_GPIO_WritePin(CH376_SCS_PORT,CH376_SCS_PIN,1);}



#define GPIO_ResetBits(P,I)       (HAL_GPIO_WritePin(P,I,0)) 
#define GPIO_SetBits(P,I)         (HAL_GPIO_WritePin(P,I,1)) 
