...
#define SPI_FLASH_PageSize              256//256
#define SPI_FLASH_PerWritePageSize      256//256
...
#define FLASH_SPI_CLK_ENABLE()              __SPI5_CLK_ENABLE()
...
#define FLASH_SPI_SCK_ENABLE()              __GPIOF_CLK_ENABLE()
...
#define FLASH_SPI_MISO_ENABLE()              __GPIOF_CLK_ENABLE()
...
#define FLASH_SPI_MOSI_ENABLE()              __GPIOF_CLK_ENABLE()
...
#define FLASH_CS_GPIO_ENABLE()              __GPIOF_CLK_ENABLE()
