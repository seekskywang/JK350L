...
void SDRAM_GPIO_Config(void)
{
  ...
  // 使能SDRAM相关的GPIO时钟
  FMC_A0_GPIO_CLK; FMC_A1_GPIO_CLK; FMC_A2_GPIO_CLK; FMC_A3_GPIO_CLK;
  FMC_A4_GPIO_CLK; FMC_A5_GPIO_CLK; FMC_A6_GPIO_CLK; FMC_A7_GPIO_CLK;
  FMC_A8_GPIO_CLK; FMC_A9_GPIO_CLK; FMC_A10_GPIO_CLK;FMC_A11_GPIO_CLK;
  FMC_D0_GPIO_CLK; FMC_D1_GPIO_CLK; FMC_D2_GPIO_CLK; FMC_D3_GPIO_CLK;
  FMC_D4_GPIO_CLK; FMC_D5_GPIO_CLK; FMC_D6_GPIO_CLK; FMC_D7_GPIO_CLK;
  FMC_D8_GPIO_CLK; FMC_D9_GPIO_CLK; FMC_D10_GPIO_CLK;FMC_D11_GPIO_CLK;
  FMC_D12_GPIO_CLK;FMC_D13_GPIO_CLK;FMC_D14_GPIO_CLK;FMC_D15_GPIO_CLK;
  FMC_CLK_GPIO_CLK;FMC_WE_GPIO_CLK; FMC_CS_GPIO_CLK; FMC_CKE_GPIO_CLK;
  FMC_RAS_GPIO_CLK;FMC_CAS_GPIO_CLK;FMC_BA0_GPIO_CLK;FMC_BA1_GPIO_CLK;
  FMC_LDQM_GPIO_CLK;                FMC_UDQM_GPIO_CLK;
...
//#define SDCLOCK_PERIOD    ((uint32_t)0x0000CC00)
/**
